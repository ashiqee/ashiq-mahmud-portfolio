        ...
        <div className="container mx-auto pt-20 my-auto min-h-screen">
            <div className="text-center  ">
                <div className="pb-10 space-y-4">
                    <h2 className="text-3xl"><TextHover>What i Do!</TextHover></h2>
                    <p className="md:w-1/2 sm:mx-12 md:mx-auto">👋Passionate MERN (MongoDB, Express.js, React.js, Node.js) stack developer eager to make a mark in the world of web development.</p>
                </div>
                <div className="grid max-w-screen-lg md:mx-auto mx-10   lg:grid-cols-8 md:grid-cols-6  grid-cols-4 justify-around gap-5">


                    {skillData.map(data =>
                        <div className=" w-16" key={data.id}>
                            <motion.div
                                initial={{ scale: 0 }}
                ...
                <div className="grid max-w-screen-md md:mx-auto mx-20   lg:grid-cols-5 md:grid-cols-4 mt-5 ml-10 grid-cols-3 justify-items-center gap-1">
                    {skillData2.map(data =>
                        <div className=" w-16" key={data.id}>
                            <motion.div
                                initial={{ scale: 0 }}
